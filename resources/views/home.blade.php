      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
            {!! html_entity_decode($about->long_desc)!!}
            <!-- <ul>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Here is the services we offer</p>
        </div>

        <div class="row">

          @foreach($services as $key=>$service)
          <div class="col-lg-4 col-md-6" style="margin-bottom:10px" data-aos="zoom-in" data-aos-delay="{{($key+1)*100}}">
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-bouqet">
